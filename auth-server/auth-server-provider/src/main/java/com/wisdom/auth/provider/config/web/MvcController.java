...
import com.wisdom.auth.db.feignclient.BaseClientService;
...
//            System.out.println("====baseClientService2=====");
        ...
        if(responseData!=null&&ResponseCode.SUCCESS.getCode().equals(responseData.getCode()) && responseData.getData() != null) {
